...
n_node_fuselage = 0 #n_elem_fuselage*(n_node_elem - 1) + 1

# total number of nodes
n_node = 0
n_node += n_node_main + n_node_main
...
def generate_solver_file():
    ...
    settings['StaticUvlm'] = {'print_info': 'on',
                              'horseshoe': 'off',
                              'nonlifting_body_interactions': 'off',
                              'num_cores': num_cores,
                              'n_rollup': 0,
                              'rollup_dt': dt,
